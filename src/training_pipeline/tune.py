...
- Optimizes XGV params on eval set RMSE.
- Log trains to MLflow
- Retrains best model and save to `model_output`
...
def tune_model(
    ...
    X_train, y_train, X_eval, y_eval =_load_data(train_path=train_path,
                                                eval_path=eval_path,
